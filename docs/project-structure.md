...
**Файл:** снимок структуры на эту дату. Назначение и API системы — в [`docs/system.md`](system.md); статусы ТЗ — в [`docs/specs/README.md`](specs/README.md).
...
| Путь | Роль |
|------|------|
| `docs/system.md` | Обзор системы, сущности, основные API |
| `docs/specs/README.md` | Реестр ТЗ: статус, роль, остаток |
| `docs/specs/*.md` | Источники истины по фичам (19 файлов) |
| `docs/templates/` | Шаблон ТЗ и промпты (plan / implement / bugfix / review / release) |
| `docs/auth-mvp-runbook.md`, `docs/auth-validation-checklist.md` | Auth-процедуры |
| `docs/release-notes-routes-quotes-rollout.md` | Исторический rollout маршрутов |
...
2. Открыть [`docs/specs/README.md`](specs/README.md), затем одну спеку.
