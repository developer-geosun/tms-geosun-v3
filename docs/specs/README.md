...
Перед кодом: этот реестр → нужный файл → поле «Связанные» в шапке той спеки. Не читать все 17 файлов подряд.
...
|------------------------|--------|
| Готово в продукте (включая контракты «в силе») | **15** |
| Частично | **1** (`document-types-reference`) |
