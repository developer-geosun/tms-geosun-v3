...
- **Клиент:** Angular + Java
- **Остаток:** нет в этом файле. Блокировка маршрута, `view`, restore, отложенный breakdown — [route-immutability-list-filters-deferred-country-breakdown.md](route-immutability-list-filters-deferred-country-breakdown.md). Ставка — [freight-cost-scenario-nbu-pricing.md](freight-cost-scenario-nbu-pricing.md)
