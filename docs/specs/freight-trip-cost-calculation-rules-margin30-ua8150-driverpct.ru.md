...
**Текстовое описание:** поле `calculationSummary` — человекочитаемый отчёт по блокам (см. [`freight-cost-scenario-nbu-pricing.ru.md`](./freight-cost-scenario-nbu-pricing.ru.md) §7.1); числа в тексте должны совпадать с JSON breakdown.