...
## 2) Context / Контекст
- **Related:** `drivers-and-vehicle-combinations.ru.en.md`, `routes-server-workflow-and-freight-quoting.ru.en.md`.
...
- [x] Tests + system.ru.md updated (`TripAndExpenseIntegrationTest`).
