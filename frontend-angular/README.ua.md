...
- Node.js `22.14` LTS (рекомендовано; мінімум `22.13+` на гілці 22). Також підтримуються `20.19+` LTS і `24+`.
- npm `>=10`
- Версія в `.nvmrc` (`22.14.0`); `nvm use` / `fnm use` у каталозі `frontend-angular`.
